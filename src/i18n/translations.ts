...
export const translations = {
  ru: {
    ...
    traditionalShort: 'Традиционные',
    traditionalHint: 'Доллары, евро, рубли и другие фиатные валюты',
    crypto: 'Криптовалюта',
    cryptoShort: 'Крипто',
    cryptoHint: 'Bitcoin, Ethereum и другие криптовалюты',
  ...
  en: {
    ...
    traditionalShort: 'Fiat',
    traditionalHint: 'Dollars, euros, rubles and other fiat currencies',
    crypto: 'Crypto',
    cryptoShort: 'Crypto',
    cryptoHint: 'Bitcoin, Ethereum and other cryptocurrencies',
